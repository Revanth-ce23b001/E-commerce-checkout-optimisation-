...
- params sha256: `e85ccf6f8ee74a42b53091053b1a2b95…`
- dgp sha256: `aeb6a23def1fcce7aa64a76f3774a4e0…`
- generated: 2026-08-24T17:25:39.232409+00:00
...
| `fct_order` | 105,597 |
| `fct_order_economics` | 105,597 |
| `fct_payment_attempt` | 49,042 |
...
| Quantity | Value |
|---|---:|
| naive COD−prepaid gap | 17.47pp |
| average marginal effect | 9.94pp |
| selection share of the gap | 0.431 |
| naive ÷ truth | 1.76× |
...
|---|---|---|---|---|---|
| VOL-01 | HARD | PASS | fct_order row count | >= 100,000 | 105,597 |
...
| VOL-03 | SOFT | PASS | Distinct customers with >=1 order | >= 40,000 | 46,537 |
| VOL-04 | HARD | PASS | Every dimension table at target +/-1% | within 1% | checked 4 dimensions |
| CAL-01 | HARD | PASS | COD share of orders | 0.62 +/-0.01 | 0.6175 |
| CAL-02 | HARD | PASS | Prepaid share | 0.38 +/-0.01 | 0.3825 |
| CAL-03 | SOFT | PASS | COD RTO rate | 0.24 +/-0.025 | 0.2305 |
| CAL-04 | SOFT | PASS | Prepaid RTO rate | 0.041 +/-0.025 | 0.0558 |
| CAL-05 | HARD | PASS | Blended RTO rate | 0.165 +/-0.01 | 0.1624 |
| CAL-06 | HARD | PASS | Checkout conversion | 0.68 +/-0.02 | 0.6813 |
| CAL-07 | SOFT | PASS | % of COD caused by payment failure | 0.068 +/-0.02 | 0.0603 |
| CAL-08 | SOFT | PASS | Addressable share of RTO cost | 0.65 +/-0.05 | 0.6090 |
...
| CAL-11 | HARD | PASS | Selection share of the naive COD-RTO gap | [0.25, 0.45] | 0.431 |
| EC-01 | HARD | PASS | Mean GMV per order | 1000 +/-25 | 1001.17 |
| EC-01b | SOFT | PASS | Mean order_value per order | 920 +/-30 | 919.70 |
| EC-02 | SOFT | PASS | Median order value | 624 +/-60 | 623.99 |
...
| EC-07 | SOFT | PASS | Annualised RTO exposure (Cr) | [150, 180] | 164.9 |
| EC-08 | HARD | PASS | Derived annualisation factor in band | [200, 280] | 227.28 |
| BR-01 | HARD | PASS | New customers use COD more | >= +10pp | +21.44pp |
| BR-02 | HARD | PASS | Prior-RTO lift, 95% CI lower bound | CI lower bound > 1.50 | 1.698x  [1.649, 1.750] |
| BR-03 | HARD | PASS | pit_cod_share predicts COD selection | >= 2.5 OR | 17.76 |
| BR-04 | SOFT | PASS | Lower seller rating -> more COD | spread >= 4% | 4.27% |
| BR-05 | SOFT | PASS | Lower product rating -> more COD | spread >= 3% | 4.33% |
| BR-06 | SOFT | PASS | COD share by value decile is inverted-U | peak in deciles 6-9 (0-indexed 5-8) | peak at 8 |
| BR-07 | HARD | PASS | Payment failure precedes some COD | [4%, 10%] | 6.03% |
| BR-08 | HARD | PASS | Address reason rises as completeness falls | Q1/Q4 >= 1.40 AND Spearman rho < 0 at p < 0.01 | gradient 1.94x, rho -0.0496, p 1.55e-09 |
| BR-09 | HARD | SKIP | Delay explains more deviance than promise | — | not runnable |
| BR-10 | SOFT | PASS | Month-end COD RTO lift | >= +1.5pp | +3.55pp |
| BR-11 | HARD | PASS | Switch-COD RTOs less than intent-COD | >= 5pp lower | +16.08pp |
...
| LK-03 | HARD | PASS | Safe-feature AUC below the leakage guard | < 0.85 | ceiling 0.7720 |
...
| LK-06 | HARD | PASS | Shrinkage prior is a declared constant, not computed from the data | rto_prior=0.165, cod_prior=0.62, k=8.0 (exact) | rto_prior=0.165, cod_prior=0.62, k=8.0 |
...
| DQ-07c | SOFT | PASS | Exclusions explained by the censoring model | excluded == censored + cancelled | excluded 14,234, censored 10,018, cancelled 4,216 |
...
| DQ-10 | HARD | PASS | Every order has exactly one economics row | 105,597 | 105,597 |
...
| DQ-14 | HARD | PASS | Censoring present in the late window | >= 0.03 | 0.3520 |
| GT-02 | HARD | PASS | Naive gap exceeds the AME | naive > AME | 17.47pp > 9.94pp |
...
| GT-05 | HARD | PASS | AUC ceiling in band | [0.74, 0.79] | 0.7720 |
